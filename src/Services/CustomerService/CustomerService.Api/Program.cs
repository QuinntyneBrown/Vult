...
using CustomerService.Api.Data.Seed;
...
builder.Services.AddScoped<ICustomerSeedService, CustomerSeedService>();
...
if (app.Environment.IsDevelopment())
{
    ...
    var seedService = scope.ServiceProvider.GetRequiredService<ICustomerSeedService>();
