...
using OrderService.Api.Data.Seed;
using System.Text;
...
builder.Services.AddScoped<IOrderSeedService, OrderSeedService>();
...
if (app.Environment.IsDevelopment())
{
    ...
    var seedService = scope.ServiceProvider.GetRequiredService<IOrderSeedService>();
